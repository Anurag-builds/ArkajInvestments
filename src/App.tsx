      ...
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-gray-800">
		...
		<span className="text-2xl font-bold">Arkaj</span>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Agri community app</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Ingredients sourcing</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Life at Arkaj</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Impact</a>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-teal-800 text-white rounded-3xl p-12 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-lg mb-8">
                  ...
                  <a href="mailto:info@arkaj.co" className="text-yellow-300 hover:text-yellow-400 transition-colors">info@arkaj.co</a>
                </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2">Commodities you source</label>
                <input
                  type="text"
                  name="commodities"
      ...
      <footer className="bg-gray-50 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              <h3 className="text-gray-900 font-bold text-lg mb-6">Building Arkaj</h3>
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Impact</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Life at Arkaj</a></li>
            ...
            <div>
              <h3 className="text-gray-900 font-bold text-lg mb-6">Our Solutions</h3>
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Ingredients Sourcing</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Agri Community App</a></li>
                <li>
                  <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors inline-flex items-center gap-2">
                    Truck tracking on SaudaBook
                    <span className="bg-yellow-300 text-black text-xs font-bold px-2 py-1 rounded">NEW</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">CSR Policy</a></li>
              </ul>
            </div>
